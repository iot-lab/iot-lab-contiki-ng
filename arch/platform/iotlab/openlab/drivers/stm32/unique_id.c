...
void uid_print()
{
    log_printf("UID32:\n\t%x\n\t%x\n\t%x\n", uid->uid32[0], uid->uid32[1],
               uid->uid32[2]);
    log_printf("UID16:\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n", uid->uid16[0],
               uid->uid16[1], uid->uid16[2], uid->uid16[3], uid->uid16[4],
               uid->uid16[5]);
    log_printf(
        "UID8:\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n\t%x\n",
        uid->uid8[0], uid->uid8[1], uid->uid8[2], uid->uid8[3],
        uid->uid8[4], uid->uid8[5], uid->uid8[6], uid->uid8[7],
        uid->uid8[8], uid->uid8[9], uid->uid8[10], uid->uid8[11]);
}
